...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        o_attack = other_card.attack
        o_defense = other_card.defense
        other_card.attack = o_defense
        other_card.defense = o_attack
        
        # Alternative: "while evaluating an assignment, the right-hand side is evaluated before the left-hand side." so the evaluation completes before any of the assignment. 
